...
var copyOptions = function (options, copyBase, args, useDefaults) {
    "use strict";
...
function generateArgument(options, useDefaults, cb) {
    "use strict";

    var args = {};
    var changes = copyOptions(options, {}, default_args, useDefaults);
